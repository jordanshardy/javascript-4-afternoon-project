...
// Write a prototype method for the User constructor function named removeSavedPost that will take 
// in one number parameter representing the post id. Use this id to find and remove the matching object in the savedPosts array.

User.prototype.removeSavedPost = function(num){
const index = this.savedPosts.indexOf(posts => posts.id === id)
...
// Write a prototype method for the User constructor function named changePostRating that 
// will take in two number parameters. The first will be an id (a number) and the second will be 
// the new rating (a number). Use the id to find the matching object in the savedPosts array. Once you find the matching object, 
// update it's rating score with the new rating parameter.

User.prototype.changePostRating = function(id, newRating){
  const index = this.savedPosts.findIndex(posts => posts.id === id)
